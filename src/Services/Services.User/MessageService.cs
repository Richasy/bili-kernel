...
public sealed class MessageService : IMessageService
{
    ...
    /// <inheritdoc/>
    public Task<(IReadOnlyList<ChatSession> Sessions, long Offset, bool HasNext)> GetChatSessionsAsync(long? offset = null, CancellationToken cancellationToken = default)
        => _myClient.GetChatSessionsAsync(offset, cancellationToken);
