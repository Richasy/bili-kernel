...
public interface IMessageService
{
    ...
    /// </summary>
    /// <remarks>
    /// 在第二次请求会话列表时，需要传入上一次请求得到的偏移值，以便获取更早的会话列表.
    /// </remarks>
    Task<(IReadOnlyList<ChatSession> Sessions, long Offset, bool HasNext)> GetChatSessionsAsync(long? offset = null, CancellationToken cancellationToken = default);
